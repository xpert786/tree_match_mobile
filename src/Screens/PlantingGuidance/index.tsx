...
import {  View, StatusBar, Text, Image, ScrollView, TouchableOpacity, FlatList, Pressable } from 'react-native';
...
const PlantingGuidance = () => {
  ...
  const renderItem = ({ item }: any) => (
    <Pressable style={styles.cardView} onPress={()=> navigate(ScreenConstants.ABOUT)}>
